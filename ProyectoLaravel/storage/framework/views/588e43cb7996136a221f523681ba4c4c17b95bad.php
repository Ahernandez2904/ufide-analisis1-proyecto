		...
		<section id="home" class="main-banner parallaxie" style="background: url('../../public/uploads/mecanica.jpg')">
			<div class="heading">
				...
				<h3 class="cd-headline clip is-full-width">
					...
					<div class="btn-ber">
						<a class="get_btn hvr-bounce-to-top" href="<?php echo e(route('register')); ?>">Inicia sesión ó regístrate</a>
					</div>
				</h3>
			</div>
		</section>
...
<?php /**PATH C:\laragon\www\fungservicioautomotriz\ProyectoLaravel\resources\views/Index.blade.php ENDPATH**/ ?>