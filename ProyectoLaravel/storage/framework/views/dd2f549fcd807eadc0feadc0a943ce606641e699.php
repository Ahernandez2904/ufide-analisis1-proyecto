...
<?php $__env->startSection('contenido'); ?>
							...
							<select class="form-control" id="Usuario" name="Usuario">
								<?php $__empty_1 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
									<option value="<?php echo e($usuario->id); ?>">
										<?php echo e($usuario->nombre); ?> <?php echo e($usuario->apellidos); ?>
			...
			<?php $__empty_1 = true; $__currentLoopData = $citas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
				<tr>
					...
					<td>
						...
						<form method="POST" action="<?php echo e(url('/CitasAdmin/'.$cita->id)); ?>">
							<?php echo csrf_field(); ?> 
	...
	<div id="modalEditarCita" class="modal modal-top fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form id="add-event" method="POST" action="<?php echo e(url('/CitasAdmin/'.$cita->id)); ?>">
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layoutAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fungservicioautomotriz\ProyectoLaravel\resources\views/citasAdmin.blade.php ENDPATH**/ ?>