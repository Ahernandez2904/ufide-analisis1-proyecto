		...
		<table id="" class="table table-bordered" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<?php $__empty_1 = true; $__currentLoopData = $vehiculos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiculo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					...
					<td><?php echo e($vehiculo->cilindraje_motor); ?></td>
					...
					<?php if(session('error')): ?>
						<div class="alert alert-danger"><?php echo e(session('error')); ?></div>
									<?php endif; ?>
					<form method="POST" action="<?php echo e(url('/perfilAdminVehiculo/'.$vehiculo->id)); ?>">
							<?php echo csrf_field(); ?> 
	...
	<div id="modalEditarVehiculo" class="modal modal-top fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form id="add-event" method="POST" action="<?php echo e(url('/perfilAdminVehiculo/'.$vehiculo->id)); ?>">
					<?php echo csrf_field(); ?>
					...
					<div class="form-group">
							...
							<select class="form-control"  id="id" name="id">
								<?php $__empty_1 = true; $__currentLoopData = $vehiculos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiculo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										<?php if(old('id') == $vehiculo->id): ?>
													<option value="<?php echo e($vehiculo->id); ?>" selected><?php echo e($vehiculo->id); ?></option>
															<?php else: ?>
													<option value="<?php echo e($vehiculo->id); ?>"><?php echo e($vehiculo->id); ?></option>
												<?php endif; ?>
						...
						<div class="form-group">
							<label>Año</label>
							<input type="text" class="form-control"  name="anio" value="<?php echo e(old('anio', $vehiculo->anio)); ?>" />
						</div>
						<div class="form-group">
							<label>Cilindrada</label>
						
							<input type="text" class="form-control"  name="cilindraje_motor" value="<?php echo e(old('cilindraje_motor', $vehiculo->cilindraje_motor)); ?>" />
						</div>
						<div class="form-group">
							<label>Marca</label>
						
							<input type="text" class="form-control"  name="marca" value="<?php echo e(old('marca', $vehiculo->marca)); ?>" />
							
						</div>
						<div class="form-group">
							<label>Modelo</label>
						
							<input type="text" name="modelo"class="form-control"   value="<?php echo e(old('modelo', $vehiculo->modelo)); ?>" />
						</div>
						<div class="form-group">
							<label>Placa</label>
							
							<input type="text" class="form-control"  name="placa" value="<?php echo e(old('placa', $vehiculo->placa)); ?>" />
						</div>
...
</html><?php /**PATH C:\laragon\www\fungservicioautomotriz\ProyectoLaravel\resources\views/perfilAdminVehiculo.blade.php ENDPATH**/ ?>