				...
				<?php $__empty_1 = true; $__currentLoopData = $vehiculos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiculo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					...
					<?php if(session('error')): ?>
						<div class="alert alert-danger"><?php echo e(session('error')); ?></div>
									<?php endif; ?>
					<form method="POST" action="<?php echo e(url('/perfilClienteVehiculo/'.$vehiculo->id)); ?>">
							<?php echo csrf_field(); ?> 
	...
	<div id="modalEditarVehiculo" class="modal modal-top fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form id="add-event" method="POST" action="<?php echo e(url('/perfilClienteVehiculo/'.$vehiculo->id)); ?>">
					<?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\fungservicioautomotriz\ProyectoLaravel\resources\views/perfilClienteVehiculo.blade.php ENDPATH**/ ?>