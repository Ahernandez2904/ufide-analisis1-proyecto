...
<html lang="en">
	<head>
		...
		<!-- Site Metas -->
		<title><?php echo $__env->yieldContent('titulo'); ?> - FUNG Servicio Automotriz</title>
		<meta name="keywords" content="">
		<meta name="description" content="">
		<meta name="author" content="">

		<!-- Site Icons -->
		<link rel="shortcut icon" href="<?php echo e(URL::asset('images/LofoFungU.ico')); ?>" type="image/x-icon" />
		<link rel="apple-touch-icon" href="<?php echo e(URL::asset('images/apple-touch-icon.png')); ?>">
		...
		<script src="<?php echo e(URL::asset('js/modernizr.js')); ?>"></script>
		<!-- Schedules CSS -->
		<link rel="stylesheet" href="<?php echo e(URL::asset('css/citas_style.css')); ?>">
		<!--[if lt IE 9]>
	...
	<body id="page-top" class="politics_version">
		...
		<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
			<div class="container">
				<a class="navbar-brand js-scroll-trigger" href="#page-top">
					<img class="img-fluid" src="<?php echo e(URL::asset('images/LogoFung.png')); ?>" alt="" />
				</a>
		...
		<!-- ALL JS FILES -->
		<script src="<?php echo e(URL::asset('js/all.js')); ?>"></script>
		<!-- Camera Slider -->
		<!--<script src="js/jquery.mobile.customized.min.js"></script>-->
		<script src="<?php echo e(URL::asset('js/jquery.easing.1.3.js')); ?>"></script> 
		<script src="<?php echo e(URL::asset('js/parallaxie.js')); ?>"></script>
		<script src="<?php echo e(URL::asset('js/headline.js')); ?>"></script>
		...
		<script src="<?php echo e(URL::asset('js/jquery.vide.js')); ?>"></script>
		<!-- Citas anterior -->
		...
		<script src="<?php echo e(URL::asset('js/citas_script.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\fungservicioautomotriz\ProyectoLaravel\resources\views/layoutAdmin.blade.php ENDPATH**/ ?>